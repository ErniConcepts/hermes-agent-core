...
```bash
curl -fsSL https://raw.githubusercontent.com/ErniConcepts/hermes-agent-core/e2922ca2c565e08de9e591d4ed91f99cba4e5cf0/scripts/install-product.sh -o install-product.sh
